...
1. Выделил список статей внутри темы.
2. Собрал базовые понятия и связи между ними.
3. Подготовил тексты страниц для `WEB/.../concepts/`.
4. Составил черновые запросы к WikiData и DBpedia.
5. Подготовил место под выгрузки и визуальную схему.
